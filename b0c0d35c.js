      ...
      return (
        (t =
          void 0 === e.header
            ? a` ${
                null !== e.label
                  ? a`<label class="input-group-text col-3 mb-1"
            >${i(e.label)}</label
          >`
                  : a``
              }
          ...
          a` ${
            3 === e.length
              ? a` <input
                ...
                >`
              : 4 === e.length
              ? a` <label class="input-group-text col-2 mb-1"
                  >${i(e[2])}</label
                >
                <input
            ...
            : a`${e.header.map(
                e => a`<label class="input-group-text col-3 mb-1">${e}</label>`
              )}`),
        t
      );
    }
...
class r extends o {
  ...
  async getMasonryLayout() {
    for (
      ...
      (this.masonryLayout = l.data('.msnry-tiles')), await n(2);
  }
  async reloadMasonry() {
  ...
  modifyForm(e) {
    p(this.appWebComponents, e.changeFields);
