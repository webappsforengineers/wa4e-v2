import { S as t, $ as e, T as s, p as i } from './3db1be05.js';
    ...
    render() {
      return (
        ...
        >
          ...
          />
          <div class="card-body">
            <h6 class="card-title">${e([this.appConf.appTitle])}</h6>
...
customElements.define(
  ...
  class extends s {
    ...
    arrangeFields() {
      return e`${Object.keys(this.formFields).map((t, s) => {
        let i, n, a;
        return (
          void 0 === this.subComponents
            ? ([i, n, a] = [[], [], []])
            : ([i, n, a] = this.getSubComponents(this.subComponents, s)),
          e`
        <div>
          ${e`${i.map(t => this.makeSubComponent(t))}`}
        </div>
        <h3>${e([t])}</h3>
        <div>
...
customElements.define(
  ...
  class extends s {
    ...
    arrangeFields() {
      return e`${Object.keys(this.text).map((t, s) => {
        let i, n, a;
        return (
          void 0 === this.subComponents
            ? ([i, n, a] = [[], [], []])
