  ...
  appWebComponents: {
    ...
    1: {
      ...
      fields: {
        ...
        Chain: {
          d: { label: 'd', unit: 'm', value: 0.1, visible: '', lb: '', ub: '' },
          bd: {
            label: 'b/d',
            unit: null,
            value: 2.5,
      ...
      subComponents: {
        0: { type: 'soil-properties-help', index: 0, position: 'afterTitle' },
      },
    ...
    5: {
      ...
      plots: {
        plotSum: {
          dataFun: (e, l, i) => [{ name: `Sum = ${i}`, x: e, y: l }],
          layout: {
            type: 'scatter',
            title: 'S<sub>um</sub> = 0 kPa',
            xaxis: { title: 'S<sub>um</sub> (kPa)' },
            yaxis: { title: 'z<sub>f</sub>(m)' },
            mode: 'lines',
            line: { shape: 'spline' },
            font: { size: 18 },
          },
        ...
        plotKsu: {
          dataFun: (e, l, i) => [{ name: `k<sub>su</sub> = ${i}`, x: e, y: l }],
          layout: {
            type: 'scatter',
