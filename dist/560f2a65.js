const l = {
  ...
  appWebComponents: {
    ...
    1: {
      ...
      fields: {
        'Mudmat Geometry': {
          B: { label: 'B', unit: 'm', value: 7.5, visible: '', lb: '', ub: '' },
          BoverL: {
            label: 'B/L',
            unit: null,
            value: 0.5,
        ...
        'Pile Group Geometry': {
          ...
          B_piles: {
            ...
            lb: '0',
            ub: () =>
              l.appWebComponents[1].fields['Mudmat Geometry'].B.value -
              l.appWebComponents[1].fields['Pile Group Geometry'].D_pile.value,
          },
          L_piles: {
            ...
            lb: '0',
            ub: () =>
              2 * l.appWebComponents[1].fields['Mudmat Geometry'].B.value -
              l.appWebComponents[1].fields['Pile Group Geometry'].D_pile.value,
          },
          L_embed: {
      ...
      subComponents: {
        ...
        1: { type: 'soil-properties-help', index: 4, position: 'afterTitle' },
      },
    ...
    3: {
      ...
      plots: {
        mudmatDesign: {
          dataFun: (l, e, a, s, u, i, t) => [
            { x: l, y: e, name: 'Zero Torque', type: 'scatter' },
            {
              x: a,
              y: s,
              name: `T = ${Number(t).toFixed(1)} kNm`,
              type: 'scatter',
            },
            {
              x: [u],
          ...
          layout: {
            ...
            yaxis: { title: 'Resultant moment (kNm)', titlefont: { size: 16 } },
            showlegend: !0,
            legend: { x: 1, y: 0.5 },
            font: { size: 18 },
          },
        ...
        inSituUndrainedStresses: {
          dataFun: (l, e, a, s, u, i, t) => [
            { x: l, y: e, name: 'T = 0', type: 'scatter' },
            {
              x: a,
              y: s,
              name: `T = ${Number(t).toFixed(1)} BH`,
              type: 'scatter',
            },
            {
              x: [u],
