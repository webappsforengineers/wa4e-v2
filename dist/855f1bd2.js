  ...
  appWebComponents: {
    ...
    5: {
      ...
      plots: {
        inSituStresses: {
          dataFun: (e, l, s, u, a) => [
            { x: e, y: l, name: '&sigma;&#39;<sub>v</sub>', type: 'scatter' },
            { x: e, y: s, name: 'u<sub>hyd</sub>', type: 'scatter' },
            { x: e, y: u, name: '&sigma;<sub>v</sub>', type: 'scatter' },
            { x: e, y: a, name: '&sigma;&#39;<sub>h</sub>', type: 'scatter' },
          ],
          layout: {
