const e = {
  ...
  appWebComponents: {
    0: {
      ...
      text: {
        subTitle: { text: 'Required pipe weight', format: 'h5' },
        blurb: { text: 'Still to do …', format: '' },
      },
    },
    1: {
      type: 'input-tile',
    ...
    2: {
      ...
      title: 'Data',
      text: {
        subTitle: { text: 'Recommended values from DNV-RP-F109', format: 'h4' },
        frictionTableTitle: { text: 'Friction coefficient:', format: '' },
        safteyTableTitle: { text: 'Safety factor:', format: '' },
      },
      subComponents: {
        0: {
          type: 'table-tile',
          ...
          display: '',
          title: ' ',
          content: { 1: ['Sand seabed', '0.6'], 2: ['Clay seabed', '0.2'] },
        },
        1: {
          type: 'table-tile',
          index: 2,
